...
public class FileHandler {
	...
	public List<FileVO> uploadFiles(MultipartFile[] files) {
		...
		//MultipartFile[] 받아서 FileVO 형태의 리스트를 생성 후 리턴
		...
		///Users/oh-haeun/Desktop/_myProject/_java/_fileUpload/2024/04/29
		...
		for(MultipartFile file : files) {
			...
			//저장 -> 저장 경로 또는 파일없다면 IOExeption 발생
			...
			try {
				...
				log.info(">>> file 저장 에러 : at filehandler >>>");
				e.printStackTrace();
			}		
